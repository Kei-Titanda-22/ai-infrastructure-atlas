...
import v04Batch35DocumentSources from '../data/document-sources-v04-batch35.json';
import v04Batch36DocumentSources from '../data/document-sources-v04-batch36.json';
import v04Batch37DocumentSources from '../data/document-sources-v04-batch37.json';
import v04Batch38DocumentSources from '../data/document-sources-v04-batch38.json';
import v04Batch39DocumentSources from '../data/document-sources-v04-batch39.json';
import v04Batch40DocumentSources from '../data/document-sources-v04-batch40.json';
import v04Batch41DocumentSources from '../data/document-sources-v04-batch41.json';
import v05Batch01DocumentSources from '../data/document-sources-v05-batch01.json';
import v05Batch02DocumentSources from '../data/document-sources-v05-batch02.json';
import v05Batch03DocumentSources from '../data/document-sources-v05-batch03.json';
import v05Batch04DocumentSources from '../data/document-sources-v05-batch04.json';
import v05Batch05DocumentSources from '../data/document-sources-v05-batch05.json';
import v05Batch06DocumentSources from '../data/document-sources-v05-batch06.json';
import v05Batch07DocumentSources from '../data/document-sources-v05-batch07.json';
import v05Batch08DocumentSources from '../data/document-sources-v05-batch08.json';
...
export const financialSources = [
  ...
  ...v04Batch35DocumentSources,
  ...v04Batch36DocumentSources,
  ...v04Batch37DocumentSources,
  ...v04Batch38DocumentSources,
  ...v04Batch39DocumentSources,
  ...v04Batch40DocumentSources,
  ...v04Batch41DocumentSources,
  ...v05Batch01DocumentSources,
  ...v05Batch02DocumentSources,
  ...v05Batch03DocumentSources,
  ...v05Batch04DocumentSources,
  ...v05Batch05DocumentSources,
  ...v05Batch06DocumentSources,
  ...v05Batch07DocumentSources,
  ...v05Batch08DocumentSources,

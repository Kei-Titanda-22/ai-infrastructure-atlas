...
import equipmentInspectionHistory from '../data/financial-history-v04-batch23.json';
import equipmentBondingHistory from '../data/financial-history-v04-batch24.json';
import interconnectDataCenterHistory from '../data/financial-history-v04-batch25.json';
...
import industrialMaterialsHistory from '../data/financial-history-v04-batch34.json';
import privateIndustrialHistory from '../data/financial-history-v04-batch35.json';
import cableBuildingHistory from '../data/financial-history-v04-batch36.json';
import substrateHistory from '../data/financial-history-v04-batch37.json';
import sixPeriodHistory from '../data/financial-history-v05-batch01.json';
import sixPeriodHistoryBatch02 from '../data/financial-history-v05-batch02.json';
import sixPeriodHistoryBatch03 from '../data/financial-history-v05-batch03.json';
import sixPeriodHistoryBatch04 from '../data/financial-history-v05-batch04.json';
import sixPeriodHistoryBatch05 from '../data/financial-history-v05-batch05.json';
import sixPeriodHistoryBatch06 from '../data/financial-history-v05-batch06.json';
import sixPeriodHistoryBatch07 from '../data/financial-history-v05-batch07.json';
import sixPeriodHistoryBatch08 from '../data/financial-history-v05-batch08.json';
import sixPeriodHistoryBatch09 from '../data/financial-history-v05-batch09.json';
import sixPeriodHistoryBatch10 from '../data/financial-history-v05-batch10.json';
import sixPeriodHistoryBatch11 from '../data/financial-history-v05-batch11.json';

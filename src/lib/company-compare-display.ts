...
export const compareFinancialAccountingBasisLabels = Object.freeze<Record<string, string>>({
  ...
  'Japanese GAAP consolidated': '日本会計基準（連結）',
  'Japanese GAAP non-consolidated': '日本会計基準（単体）',
  'TIFRS consolidated': '台湾IFRS（連結）',
  'TIFRS recognized by Taiwan FSC': '台湾金融監督管理委員会認定の台湾版国際財務報告基準（TIFRS）',
  'Taiwan-IFRS': '台湾版国際財務報告基準（Taiwan-IFRS）',
  IFRS: '国際財務報告基準（IFRS）',
  'IFRS consolidated': '国際財務報告基準（IFRS・連結）',
  'IFRS as adopted by the EU, consolidated': 'EU採択の国際財務報告基準（IFRS・連結）',
  'IFRS (EU), IAS 34 year-end report': 'EU採択の国際財務報告基準（IFRS・IAS第34号・年度末報告）',
  'IFRS as endorsed by Taiwan FSC': '台湾金融監督管理委員会採択の国際財務報告基準（IFRS）',
  'IFRS as endorsed by Taiwan FSC, consolidated': '台湾金融監督管理委員会採択の国際財務報告基準（IFRS・連結）',
  HKFRS: '香港財務報告基準（HKFRS）',
  'K-IFRS consolidated': '韓国採択の国際財務報告基準（K-IFRS・連結）',
  'PRC GAAP': '中国企業会計準則（PRC GAAP）',
  'US GAAP consolidated continuing operations': '米国会計基準（連結・継続事業）',
});

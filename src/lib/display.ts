...
const productInfoMap: Record<string, ProductInfo> = {
  ...
  'Ethernet switching silicon': { label: 'Ethernetスイッチ向け半導体', description: 'AIクラスタ内の大容量通信を処理するネットワーク半導体。' },
  'Connectivity semiconductors': { label: '接続・通信向け半導体', description: 'サーバーやネットワーク機器間の高速接続を支える半導体。' },

...
if len(history) < 185:
    errors.append(f'v0.4 history regression: expected at least 185 periods, got {len(history)}')
if len(covered_companies) < 69:
    errors.append(f'v0.4 coverage regression: expected at least 69 companies, got {len(covered_companies)}')
if len(multi_period_companies) < 69:
    errors.append(f'v0.4 history regression: expected all 69 covered companies to be multi-period, got {len(multi_period_companies)}')
...
if verified_metrics < 827:
    errors.append(f'v0.4 history regression: expected at least 827 verified metrics, got {verified_metrics}')
if cashflow_periods < 137:
    errors.append(f'v0.4 cash-flow regression: expected at least 137 FCF/Capex periods, got {cashflow_periods}')
if len(v04_sources) < 74:
    errors.append(f'v0.4 source regression: expected at least 74 document sources+policies, got {len(v04_sources)}')

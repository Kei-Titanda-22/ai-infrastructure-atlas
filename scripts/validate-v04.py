...
if len(history) < 197:
    errors.append(f'v0.4 history regression: expected at least 197 periods, got {len(history)}')
if len(covered_companies) < 75:
    errors.append(f'v0.4 coverage regression: expected at least 75 companies, got {len(covered_companies)}')
if len(multi_period_companies) < 75:
    errors.append(f'v0.4 history regression: expected all 75 covered companies to be multi-period, got {len(multi_period_companies)}')
...
if verified_metrics < 879:
    errors.append(f'v0.4 history regression: expected at least 879 verified metrics, got {verified_metrics}')
if cashflow_periods < 145:
    errors.append(f'v0.4 cash-flow regression: expected at least 145 FCF/Capex periods, got {cashflow_periods}')
if len(v04_sources) < 80:
    errors.append(f'v0.4 source regression: expected at least 80 document sources+policies, got {len(v04_sources)}')
